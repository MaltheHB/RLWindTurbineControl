...
class CriticNetwork(nn.Module):
    def __init__(self,beta,input_dims,n_actions,fc1_dims=256,fc2_dims=256,name='critic',chkpt_dir='C:\Users\malth\Desktop\Vestas OpenFAST\RL-SAC algorithm'):
...
class ValueNetwork(nn.Module):
    def __init__(self,beta,input_dims,fc1_dims=256,fc2_dims=256, name = 'value',chkpt_dir='C:\Users\malth\Desktop\Vestas OpenFAST\RL-SAC algorithm'):
...
class ActorNetwork(nn.Module):
    def __init__(self,alpha,input_dims,max_action,fc1_dims=256,fc2_dims=256,n_actions = 2, name='actor', chkpt_dir='C:\Users\malth\Desktop\Vestas OpenFAST\RL-SAC algorithm'):
